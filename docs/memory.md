...
- **Что сделано:** снят yaml-слой **проектов** (`project.yaml`, раздел «Проекты» в UI, API назначений, расстановка); справочники — только PostgreSQL.
...
**Статус планирования:** Сотрудники и ОТКК — PostgreSQL (RelaxDev); проекты — yaml-слой снят, следующий шаг — схема в БД  
