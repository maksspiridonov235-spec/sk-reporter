...
- **Что сделано:** подрядчики и проекты в PostgreSQL: таблицы `contractors`, `projects`, `project_engineers`; при старте сид **Евракор** из болванки `data/templates/Евракор.docx`; UI `/planning/contractors`, `/planning/projects`.
