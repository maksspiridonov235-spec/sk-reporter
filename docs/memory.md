...
- **Что сделано:** вкладка **Проекты** — карточки в PostgreSQL (ВОР + ТЛ), UI как ОТКК («Открыть»); пилот `SUP-PDR-ENC-001-DD-ST01-EV_00.1`; **импорт с диска удалён** — только эталоны в репо → seed при старте.
